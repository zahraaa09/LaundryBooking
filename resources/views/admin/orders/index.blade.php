...
<div class="container mx-auto px-4 py-4">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.orders.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Tambah Pesanan</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="border-b">
                ...
                <td class="px-3 py-2 flex gap-2">
                    ...
                    <a href="{{ route('admin.orders.edit', $order) }}" class="text-green-600">Edit</a>
